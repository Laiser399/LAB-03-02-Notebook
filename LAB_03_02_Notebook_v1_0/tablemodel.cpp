...
//        user->phoneNumbers.append("123");
//        user->phoneNumbers.append("-092134=213");


//    tableArr.append(spUser(user));

//    user = new User;
//    user->name = "qwe";
//    user->surname = "2121";
//    user->patronymic = "pat1221ronymic";
//    user->email = "323";
//    user->company = "wqe";
//    user->position = "qwe";
//        user->phoneNumbers.append("123");
//        user->phoneNumbers.append("4=213");
